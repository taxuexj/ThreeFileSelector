package com.three.fileselector.util;
...
/**
 * Created by three on 2018/08/09.
 */
...
public class FileUtil {
    ...
    public static int getFileTypeImageId(Context mContext, String fileName) {
        ...
        if (checkSuffix(fileName, new String[]{"doc", "docx"})) {
            ...
            id = R.mipmap.ic_excel;
        } else if (checkSuffix(fileName, new String[]{"pdf"})) {
            id = R.mipmap.ic_pdf;
        } else if (checkSuffix(fileName, new String[]{"txt"})) {
            id = R.mipmap.ic_txt;
        } else if (checkSuffix(fileName, new String[]{"zip","rar"})) {
            id = R.mipmap.ic_zip;
        }else {
            id = R.mipmap.ic_single_file;
        }
        return id;
    }
...
//    }
    ...
    private static List<FileInfoBean> FilesInfo(File fileDir, Context mContext) {
